...
const LandScreen = ({ navigation, route }) => {
  ...
  async function playSound() {
    ...
    const { sound } = await Audio.Sound.createAsync(land.audio);
    setSound(sound);
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: COLORS.white }}>
      ...
      <ImageBackground style={{ flex: 0.5 }} source={land.image}>
      ...
      <View style={styles.detailsContainer}>
          ...
          <View style={{ marginLeft: 30, flexDirection: "row" }}>
            <TouchableOpacity style={{ padding: 8 }}>
              <AntDesign
                ...
                size={25}
                color={COLORS.red}
                onPress={() => Linking.openURL(land.url)}
              />
            </TouchableOpacity>
        ...
        <View style={{ marginBottom: 20 }}>
          ...
          {/* <View style={{marginBottom:40}}>
            ...
            />
            <Button onPress={addComment} title="Gửi" />
            <FlatList
              data={commentList}
